...
| [[https://github.com/asherbender/emacs-dot-files/blob/master/config/init-undo.org][Undo]]         | Configure undo system                          |
...
| [[https://github.com/asherbender/emacs-dot-files/blob/master/config/init-repeat.org][Repeat]]       | Convenient way to repeat previous commands     |
